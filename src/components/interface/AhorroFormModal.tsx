      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-2xl p-5 space-y-4 shadow-2xl border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white relative">
        <div className="flex justify-between items-center pb-3 border-b border-slate-200 dark:border-slate-800">
          <div className="flex items-center gap-2">
            <h3 className="text-base font-bold text-violet-600 dark:text-violet-400 tracking-tight">
              {initialData?.idahorro ? 'Editar Ahorro (RF15-RF17)' : 'Nuevo Ahorro (RF15-RF17)'}
            </h3>
            <span className="text-[10px] uppercase font-extrabold bg-amber-500/20 text-amber-600 dark:text-amber-300 border border-amber-500/30 px-2 py-0.5 rounded-md">
              Solo Admin
            </span>
          </div>
          <button
        ...
        {!isAdmin && (
          <div className="p-3 bg-amber-500/10 border border-amber-500/30 rounded-xl text-xs text-amber-700 dark:text-amber-200 flex items-start gap-2">
            <ShieldAlert className="w-4 h-4 shrink-0 text-amber-500 dark:text-amber-400 mt-0.5" />
            <div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="space-y-1">
            <label htmlFor="ahorro-periodo" className="text-xs font-semibold text-violet-600 dark:text-violet-300 flex items-center gap-1">
            ...
            <select
              ...
              className="w-full h-9 px-3 rounded-xl border border-violet-500/30 bg-slate-100 dark:bg-slate-950 text-xs font-bold text-violet-700 dark:text-violet-200 focus:outline-none focus:ring-2 focus:ring-violet-500 disabled:opacity-50"
            >
          ...
          {/* Importe y Moneda */}
          <div className="space-y-1">
            <label htmlFor="ahorro-importe" className="text-xs font-medium text-slate-700 dark:text-slate-300">Importe y Moneda *</label>
            <div className="flex gap-2">
              <Input
                ...
                className="flex-1 bg-slate-100 dark:bg-slate-950 border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-100 font-semibold disabled:opacity-50"
              />
              <select
                value={moneda}
                disabled={!isAdmin}
                ...
                className="h-9 px-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-950 text-xs font-semibold text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-violet-500 disabled:opacity-50"
              >
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="space-y-1">
              <label htmlFor="ahorro-desde" className="text-xs font-medium text-slate-700 dark:text-slate-300">Fecha Desde</label>
              <Input
                id="ahorro-desde"
                type="date"
                required
                ...
                className="bg-slate-100 dark:bg-slate-950 border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-100 text-xs disabled:opacity-50"
              />
            </div>
            <div className="space-y-1">
              <label htmlFor="ahorro-hasta" className="text-xs font-medium text-slate-700 dark:text-slate-300">Fecha Hasta</label>
              <Input
                id="ahorro-hasta"
                type="date"
                required
          ...
          {/* Comentario / Nombre */}
          <div className="space-y-1">
            <label htmlFor="ahorro-comentario" className="text-xs font-medium text-slate-700 dark:text-slate-300">Nombre / Destino del Ahorro</label>
            <Input
